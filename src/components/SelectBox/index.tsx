...
const variants = {
  ...
  fill: { gray_100: "bg-gray-100 text-black-900" },
} as const;
const shapes = { square: "rounded-none" } as const;
const sizes = {
  xs: "pb-[11px] pt-[13px] px-[11px]",
  sm: "pl-5 sm:pr-5 pr-[22px] py-[22px]",
} as const;
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#0e1112",
              "&:hover": { backgroundColor: "#0e1112", color: "#0e1112" },
            }),
