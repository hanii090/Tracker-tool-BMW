...
type MetadataProps = React.DetailedHTMLProps<
  ...
  return (
    <>
      <div className={props.className}>
        <div className="bg-gray-100 flex md:flex-col flex-row md:gap-5 items-center sm:items-stretch justify-start sm:justify-start p-[18px] w-full">
